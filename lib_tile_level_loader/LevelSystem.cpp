...
void LevelSystem::setColor(LevelSystem::TILE t, sf::Color c) {
    //@TODO --
            /*You should complete the setColor function.
            It’s super simple, but you may have to look up the C++ docs/API on the std::map.
            Again, you should be looking up the API all the time for what you are using.
            Oh, also note that again we’re using smart pointers throughout!*/
}
